...
class S {
  ...
  String get completeYourProfileAddressToContinue {
    return Intl.message(
      'Complete your profile address to continue',
      name: 'completeYourProfileAddressToContinue',
      desc: '',
      args: [],
    );
  }

  String get completeYourProfilePhoneToContinue {
    return Intl.message(
      'Complete your profile phone to continue',
      name: 'completeYourProfilePhoneToContinue',
      desc: '',
      args: [],
    );
  }
  ...
  String get completeYourProfileVeriToContinue {
    return Intl.message(
      'Complete your profile verifiedPhone to continue',
      name: 'completeYourProfileVerifiedPhoneToContinue',
      desc: '',
      args: [],
    );
  }

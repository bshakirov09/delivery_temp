...
class _MobileVerificationBottomSheetWidgetState extends State<MobileVerificationBottomSheetWidget> {
  ...
  verifyPhone() async {
    ...
    smsSent = '';
    final PhoneCodeAutoRetrievalTimeout autoRetrieve = await (String verId) {};
    final PhoneCodeSent smsCodeSent = await (String verId, [int forceCodeResent]) {
      print("verid2: $verId");
      currentUser.value.verificationId = verId;
    };
    print(widget.user.phone);
    print("code $smsCodeSent");
              ...
              children: <Widget>[
                ...
                BlockButtonWidget(
                  onPressed: () async {
                    ...
                    PhoneAuthProvider.credential(verificationId: currentUser.value.verificationId, smsCode: smsSent);
